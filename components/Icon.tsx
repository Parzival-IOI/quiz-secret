...
export function Home() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-brightness-low" viewBox="0 0 16 16">
...
export function Circle() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-circle-fill" viewBox="0 0 16 16">
...
export function Wrong({className} : {className: string}) {
    return (
        <div className={className}>
