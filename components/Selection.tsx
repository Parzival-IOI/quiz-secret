...
const Selection = (props: {option: userRoleType[], name: string, label: string}) => {
  return (
    <Field>
        ...
        <div className="mt-2">
            <Select name={props.name} id={props.name} className="block w-full h-10 rounded-md border-0 text-black px-2 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                {
