    ...
    <>
      ...
      <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-30">
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="max-w-lg space-y-4 shadow-sm dark:shadow-slate-300 shadow-slate-800 bg-slate-950/80 dark:bg-slate-300/95 text-white dark:text-black px-8 py-4 rounded-lg">
